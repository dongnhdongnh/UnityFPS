namespace Pathfinding {
	...
	public static class EditorResourceHelper {
		...
		public static Material GizmoSurfaceMaterial {
			get {
				if (!surfaceMat) surfaceMat = Resources.Load<Material>("astar_navmesh_surface"); //UnityEditor.AssetDatabase.LoadAssetAtPath(EditorResourceHelper.editorAssets + "/Materials/Navmesh.mat", typeof(Material)) as Material;
				return surfaceMat;
			}
		}
		...
		public static Material GizmoLineMaterial {
			get {
				if (!lineMat) lineMat = Resources.Load<Material>("astar_navmesh_outline"); //UnityEditor.AssetDatabase.LoadAssetAtPath(EditorResourceHelper.editorAssets + "/Materials/NavmeshOutline.mat", typeof(Material)) as Material;
				return lineMat;
			}
		}
