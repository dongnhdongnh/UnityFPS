...
namespace Pathfinding.Util {
	...
	public struct NodeHasher {
		...
		public static implicit operator RetainedGizmos.Hasher(NodeHasher hasher) {
	...
	public class GraphGizmoHelper : IAstarPooledObject, System.IDisposable {
		...
		public static GraphGizmoHelper GetSingleFrameGizmoHelper (RetainedGizmos gizmos, AstarPath active, RetainedGizmos.RedrawScope redrawScope) {
			return GetGizmoHelper(gizmos, active, RetainedGizmos.Hasher.NotSupplied, redrawScope);
		}

		public static GraphGizmoHelper GetGizmoHelper (RetainedGizmos gizmos, AstarPath active, RetainedGizmos.Hasher hasher, RetainedGizmos.RedrawScope redrawScope) {
		...
		public void Init (AstarPath active, RetainedGizmos.Hasher hasher, RetainedGizmos gizmos, RetainedGizmos.RedrawScope redrawScope) {
			if (active != null) {
