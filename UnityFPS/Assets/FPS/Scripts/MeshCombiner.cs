...
public class MeshCombiner : MonoBehaviour
{
    ...
    public void Combine()
    {
        ...
        {
            MeshCombineUtilityFPS.Combine(validRenderers, MeshCombineUtilityFPS.RendererDisposeMethod.DestroyRendererAndFilter, "Level_Combined");
        }
    }
    ...
    void CombineAllInBounds(Bounds bounds, List<MeshRenderer> validRenderers)
    {
        ...
        {
            MeshCombineUtilityFPS.Combine(renderersForThisCell, MeshCombineUtilityFPS.RendererDisposeMethod.DestroyRendererAndFilter, "Level_Combined");
        }
    }
